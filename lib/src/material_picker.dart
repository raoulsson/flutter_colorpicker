...
class _MaterialPickerState extends State<MaterialPicker> {
  ...
  @override
  void initState() {
    for (List<Color> col in _colorTypes) {
      _shadingTypes(col).forEach((Map<Color, String> color) {
        if (widget.pickerColor.value == color.keys.first.value) {
          return setState(() {
            _currentColorType = col;
        ...
        child: ListView(
          ...
          children: [
            ...
            ..._shadingTypes(_currentColorType).map((Map<Color, String> color) {
              final Color col = color.keys.first;
              return GestureDetector(
                onTap: () {
                  setState(() => _currentShading = col);
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: useWhiteForeground(col) ? Colors.white : Colors.black,
